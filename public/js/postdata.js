        ...
        $.ajax(
            {
                ...
                success : function(response) {
                    ...
                    if(formData.value == ''){
                        ...
                        frequentList = response[1];
                        for(var y =0; y<frequentList.length;y++){
                            
                            $('#frequent-'+y).empty();
                            $('#frequent-name-'+y).empty();
                            keyword = frequentList[y].palette.keyword;

                            //capitalizing the first letter
                            
                            if(keyword.length == 1){
                                $('#frequent-name-'+y).append((y+1)+ '. '+keyword.charAt(0).toUpperCase());
                                
                            }else{
                                $('#frequent-name-'+y).append((y+1)+ '. '+keyword.charAt(0).toUpperCase() + keyword.substring(1));
                                
                            }
                            
                            $.each(frequentList[y].palette.colors, function (i, color) {
                                ...
                                //formula to get dynamic points to hexagon shapes 
                                var fieldsetWidth = document.getElementById('frequent-0').offsetWidth;
                                var hexSize = fieldsetWidth /14;
                                var points = hexSize + ',' + hexSize/2 + ' ' + hexSize*0.75 + ',' + hexSize*0.925 + ' ' + hexSize*0.25 + ',' + hexSize*0.925 + ' ' + 0 + ',' + hexSize/2 + ' ' + hexSize*0.25 + ',' + hexSize*0.075 + ' ' + hexSize*0.75 + ',' + hexSize*0.075;
                                var marginSize = fieldsetWidth /29 + 'px';
                                
                                $('#frequent-'+y).append('<svg id="' + id + '" class="frequencyElement" xmlns="http://www.w3.org/2000/svg" version="1.1" width= "' + hexSize + '" height="' + hexSize + '" xmlns:xlink="http://www.w3.org/1999/xlink" style = "padding:0; margin:'+marginSize+'; margin-top:20px; margin-bottom:20px;""></svg>');
                        ...
                        $.each(response[0].colors, function (i, color) {
                            ...
                            $('.paletteElement').click(function () {
                                ...
                                $('#color-harmonies').attr('style','display: flex;');
                        ...
                        for(var x =0; x<frequentList.length;x++){
                            ...
                            keyword = frequentList[x].palette.keyword;

                            //capitalizing the first letter
                            
                            if(keyword.length == 1){
                                $('#frequent-name-'+x).append((x+1)+ '. '+keyword.charAt(0).toUpperCase());
                                
                            }else{
                                $('#frequent-name-'+x).append((x+1)+ '. '+keyword.charAt(0).toUpperCase() + keyword.substring(1));
                            ...
                            $.each(frequentList[x].palette.colors, function (i, color) {
                                ...
                                $('#frequent-'+x).append('<svg id="' + id + '" class="frequencyElement" xmlns="http://www.w3.org/2000/svg" version="1.1" width= "' + hexSize + '" height="' + hexSize + '" xmlns:xlink="http://www.w3.org/1999/xlink" style = "padding:0; margin:'+marginSize+'; margin-top:20px; margin-bottom:20px;""></svg>');
